...
[TRd1,TTd1,~] = icp(wc, afd1+[locd1;0], iter, 'Matching', 'kDtree', 'WorstRejection', 0.1);

rotd1 = TRd1(1:2,1:2)*rotd1;
locd1 = rotd1*locd1+TTd1(1:2,1);
obj = rotd1*afd1(1:2,:)+locd1;
...
hold on
scatter(obj(1,:),obj(2,:),'filled','MarkerFaceColor','r','SizeData',3)
hold on
% Trajectory
scatter(trajectory(1,:),trajectory(2,:),'filled','MarkerFaceColor',trajcolor,'SizeData',5)
scatter(trajectory(1,it),trajectory(2,it),'Marker','x','MarkerEdgeColor','b','LineWidth',10)
% Location
