...
dt1 = zeros(1, floor(m/16/step));   % |TT| of d12 in each iteration
dt2 = zeros(1, floor(m/16/step));   % |TT| of d34 in each iteration
ptnumratio1 = zeros(1, floor(m/16/step));  % Ratio of number of pt w/ and w/o MF
ptnumratio2 = zeros(1, floor(m/16/step));  % Ratio of number of pt w/ and w/o MF
...
% close(outputV)
% saveas(gcf,'figure/0726_traj_dr_03.jpg')
figure
plot(rjNum)
hold on
plot([20:20:length(rjNum)],rjNum(20:20:end),'Color','r')
hold off
title('Number of rejected pairs: All')
saveas(gcf,'figure/0801_dr_10_rjNumall.jpg')
figure
plot(rjNumd1)
hold on
plot([20:20:length(rjNumd1)],rjNumd1(20:20:end),'Color','r')
hold off
title('Number of rejected pairs: L1+L2')
saveas(gcf,'figure/0801_dr_10_rjNumd1.jpg')
figure
plot(rjNumd2)
hold on
plot([20:20:length(rjNumd2)],rjNumd2(20:20:end),'Color','r')
hold off
title('Number of rejected pairs: L3+L4')
saveas(gcf,'figure/0801_dr_10_rjNumd2.jpg')
avgall = mean(rjNum)
avgd1 = mean(rjNumd1)
avgd2 = mean(rjNumd2)
disp('End')
