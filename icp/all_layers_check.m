...
for frame=1+step:step:(m/16)
    ...
    eul3 = rotm2eul(TR3);
    eul4 = rotm2eul(TR4);
    eul = [eul; [eul_all eul1(1) eul2(1) eul3(1) eul4(1)]];
    td = [td; [norm(TT) norm(TT1) norm(TT2) norm(TT3) norm(TT4)]];
...
% close(outputV)
saveas(gcf,'figure/traj_20160801101017.jpg')
...
plot(accumeul)
saveas(gcf,'figure/orientation_20160801101017.jpg')
figure('Name','distance')
plot(accumtd)
saveas(gcf,'figure/distance_20160801101017.jpg')

% figure('Name','eul range hist')
% eul = eul/pi*180;
% % eulstd = std(eul');
% % histogram(eulstd)
% eulrg = range(eul');
% histogram(eulrg)
% saveas(gcf,'figure/degrg_wr0.3_step5_hist.jpg')
% figure('Name','eul range plot')
% plot(eulrg)
% saveas(gcf,'figure/degrg_wr0.3_step5.jpg')
% figure('Name','dist range hist')
% % tdstd = std(td');
% % histogram(tdstd)
% tdrg = range(td');
% histogram(tdrg)
% saveas(gcf,'figure/distrg_wr0.3_step5_hist.jpg')
% figure('Name','dist range plot')
% plot(tdrg);
% saveas(gcf,'figure/distrg_wr0.3_step5.jpg')