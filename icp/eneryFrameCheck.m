...
for frame=1+step:step:(m/16)
    ...
    % Before transform
    subplot(2,2,1);
    scatter(bfd2(1,:),bfd2(2,:),'filled','MarkerFaceColor','k');
    hold on
    scatter(afd2(1,:),afd2(2,:),'MarkerEdgeColor','r');
    hold off
    ...
    subplot(2,2,2);
    newXY = TRd2(1:2,1:2)*bfd2(1:2,:)+TTd2(1:2,1)*ones(1,size(bfd2,2));
    scatter(newXY(1,:),newXY(2,:),'filled','MarkerFaceColor','b');
    hold on
    scatter(afd2(1,:),afd2(2,:),'filled','MarkerFaceColor','r');
    hold off 
    ...
    location = 'figure/2016_07_26_14_25_46/';
