...
wc_update=[];
scatter(wallcloud(1,:),wallcloud(2,:),'filled','MarkerFaceColor','b','SizeData',2)
...
for frame=1:step:(m/16)
    ...
    [TRd1,TTd1,p_indxd1,q_indxd1]=icpMatch(wc_U,afd1,iter,'Matching','kDtree','WorstRejection',dr);
