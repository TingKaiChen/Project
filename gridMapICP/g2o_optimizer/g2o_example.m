...
pgfilename='../pose_graph/pose_example_quatfix_fix_af.mat';

pose = [0 0 0 eul2quat([0 0 0])];

vertex(1,:) = [0, pose];
edges(1,:) = [0 1 [1 1 0]+[0.1 0.2 -0.1] eul2quat([pi/4 0 0])+[0.03 -0.05 0.02 0.01]];
...
edges(2,:) = [1 2 [1 1.4142 0]+[0.2 -0.2 0] eul2quat([-0.75*pi 0 0])+[0.02 0.03 -0.02 -0.01]];
...
edges(3,:) = [2 3 [0 1 0]+[0 0.1 0.2] eul2quat([-0.5*pi 0 0])+[-0.01 0.01 -0.02 0.01]];
...
% edges(4,6:end) = [T30(1:3,end)' rotm2quat(T30(1:3,1:3))];
