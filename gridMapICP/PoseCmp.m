...
load('./pose_graph/pose_example_trans.mat')
v_bf = vertex;
e_bf = edges;

load('./g2o_optimizer/result_example_trans.mat')
v_af = vertex;
e_af = edges;
...
figure
hold on
scatter3(v_bf(:,2),v_bf(:,3),v_bf(:,4),[5:(30-5)/(size(v_bf,1)-1):30],'k','filled');
scatter3(v_af(:,2),v_af(:,3),v_af(:,4),[5:(30-5)/(size(v_af,1)-1):30],'r','filled')
